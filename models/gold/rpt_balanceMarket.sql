with tmp_balance as (
    select c.market_id, a.symbol_id, sum( a.shares - coalesce(b.shares,0) ) as balance,
     ...
     group by c.market_id, a.symbol_id
),

stockprice as (
    select a.date_id, b.market_id, sum(a.close_vl * b.balance ) as amount_balance
      ...
      group by a.date_id, b.market_id
)
